...
public class Ex01_2_ArticleComment {
    ...
    *  Article 에서도 바인딩을 해서 양방향 바인딩으로 만들어줘야함 */
    ...
    private Ex01_2_ArticleComment(Ex01_1_Article_엔티티로_등록 article, String content) {
        this.article = article;
        this.content = content;
    }

    public static Ex01_2_ArticleComment of(Ex01_1_Article_엔티티로_등록 article, String content){
    ...
    /*  Ex01_1, Ex01_2, Ex01_3 다 하고 어플리케이션(BoardApplication.java) 실행 해보기
        ...
        방법: 1)서비스탭 열고(alt + 8 )
            ...
            이거 하는 이유: Run 탭에서 빌드작업을 하거나 테스트를 하게 되면 실행 로그랑 서비스 로그를 분리해서 볼 수 있음
